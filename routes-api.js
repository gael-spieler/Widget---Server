...
module.exports = function(app){
	...
	// Services
	app.post('/api/provider/services/:id', require('./controllers/service_create'));							// Create new service
	...
	app.get('/api/bookings/:provider_id', require('./controllers/bookings_read'));							// Create appointment
};
